...
export default {
  ...
  methods: {
    ...
    exportarExcel() {
      ...
      XLSX.utils.sheet_add_aoa(ws, [["Nombre", "DNI", "Código Matrícula", "Caja", "Carrera", "Fecha de Ingreso"]], { origin: "A1" });
...
.tabla-contenedor {
  ...
  border: 1px solid #ddd; /* Borde para mejor visualización */
}

/* Ajustar tamaño de la tabla */
.v-data-table {
  background-color: white;
  font-size: 0.85rem; /* Reducir tamaño de texto */
}
</style>

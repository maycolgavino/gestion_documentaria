...
<template>
    <div>
        <div class="min-h-screen">
            <nav class="bg-dark dark:bg-gray-700">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-500 hover:text-blue-700 bg-white hover:bg-blue-100 focus:outline-none transition ease-in-out duration-150">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('profile.edit')" class="text-gray-600"> Profile
                                        </DropdownLink>
                                        <DropdownLink :href="route('logout')" method="post" as="button"
                                            class="text-gray-600"> Log Out </DropdownLink>
                                    </template>
                                </Dropdown>
                            </div>
                        </div>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-4 pb-1 border-t border-blue-300">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('profile.edit')" class="text-gray-600 hover:text-blue-600">
                                Profile
                            </ResponsiveNavLink>
